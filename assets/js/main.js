...
(function() {
  ...
  function initLazyLoading() {
    ...
    if('IntersectionObserver' in window){
      const io = new IntersectionObserver((entries, observer)=>{
        entries.forEach(entry=>{
          if(entry.isIntersecting){
            ...
            const srcset = img.parentElement && img.parentElement.querySelector('source') && img.parentElement.querySelector('source').getAttribute('data-srcset');
            if(srcset && img.tagName.toLowerCase()==='img'){
      ...
      lazyImgs.forEach(i=>{ const s=i.getAttribute('data-src'); if(s) i.src=s; i.classList.remove('lazy'); });
    }
  }
